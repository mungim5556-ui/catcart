      ...
      case 'controls':
        this.root.innerHTML = `
          <div class="panel">
            ...
            ${
              this.h.touchMode()
                ? `<p class="tip">📱 <b>휴대폰:</b> 자동으로 달려요. ${this.h.touchMode() === 'tilt' ? '휴대폰을 <b>핸들처럼 기울여</b> 조향' : '<b>◀ ▶</b> 버튼으로 조향'}하고,<br/>브레이크 · 드리프트 · 아이템 버튼을 쓰세요. 카운트다운 중 <b>🚀</b> 버튼이 <b>초록색</b>(1)일 때 탭하면 로켓 스타트!</p>`
